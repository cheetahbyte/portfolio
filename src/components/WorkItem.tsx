	...
	return (
		<li className="border-t border-neutral-200 dark:border-neutral-700 last:border-b">
			<a
				...
				className="grid grid-cols-[1fr_auto] sm:grid-cols-[1.1fr_2fr_auto] gap-4 sm:gap-8 text-sm cursor-pointer hover:bg-neutral-200 dark:hover:bg-neutral-800 transition py-2 sm:py-3 px-3"
			>
