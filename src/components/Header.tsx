...
export default function Header() {
  ...
  return (
    <>
      ...
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 hidden md:block ${focusMode ? 'opacity-0 -translate-y-full' : 'opacity-100 translate-y-0'}`}>
        <div className="max-w-5xl mx-auto px-8 h-20 flex items-center justify-between border-b border-black/[0.03] bg-[#FAFAFA]/80 backdrop-blur-sm">
          <div className="flex items-center gap-3 font-sans text-sm tracking-wide">
            ...
            <Link className="hidden md:inline cursor-pointer" to='/'>LEONHARDBREUER.DE</Link>
          </div>
